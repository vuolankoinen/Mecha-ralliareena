...
/**
 * Swing-componentti, joka osaa piirtää pelilaudasta kuvan pelilauta-olion sille
...
public class Kuvaesitys extends JPanel implements Piirrustava {
     ...
     * Piirtää pelilaudan.
     *
     * @param laudanLeveys Montako ruutua laudalla on pystysuunnassa
     * @param laudanKorkeus Montako ruutua laudalla on vaakasuorassa
     * @param laudanElementit Laudalle piirrettävät elementit listana
     */
    @Override
    ...
    public void paintComponent(Graphics graffat) {
        ...
        for (Kuvastuva kuva : this.kuvastuvat) {
            if (kuva.mikaKuva() == 2) {
                ...
                piirraPelaaja(kuva, graffat);
                piirraHalkeamia(kuva, graffat); //Lisää säröjä pelaajamechaan, jos naarmuilla
            }
